...
namespace HairSalon.Controllers
{
  public class ClientsController : Controller
  {
    ...
    public ActionResult Index()
    {
      ...
      // ViewBag.PageTitle = "View All Clients"; if using this, naviage to _Layout.cshtml and update the head to include the page title from the ViewBag property.  Be sure to set this for each page or the default title for the page will be the current URL.
      return View(model);
    }
